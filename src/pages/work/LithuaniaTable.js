                          ...
                          <td className="text-center">
                            <div className="dropdown custom-dropdown">
                              <a
                                ...
                                href={(e) => onclick(e.preventDefault(e))}
                                role="button"
                              ...
                              <div className="dropdown-menu" aria-labelledby="dropdownMenuLink4">
                                <a className="dropdown-item" href={(e) => onclick(e.preventDefault(e))} target="_blank" without rel="noreferrer"> Download</a>
                                <a className="dropdown-item" href={(e) => onclick(e.preventDefault(e))} target="_blank" without rel="noreferrer">Delete </a>
                              </div>
                            </div>
                          </td>
                        </tr>
